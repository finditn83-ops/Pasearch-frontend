...
export default function PhoneForm({ onSubmitted }) {
  ...
  const validate = () => {
    ...
    if (!imei.trim()) e.imei = "IMEI or Serial number is required";
  ...
  const submit = async (e) => {
    ...
    fd.append("device_category", "phone");
    ...
    try {
      ...
      if (res.data?.ok) {
        ...
        alert("✅ Phone report submitted successfully!");
        onSubmitted?.(summary);
    ...
    <form onSubmit={submit} className="space-y-5" encType="multipart/form-data">
      ...
      <div>
        ...
        <input
          ...
          placeholder="e.g., Samsung, iPhone, Huawei"
        />
        {errors.brand && (
